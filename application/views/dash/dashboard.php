  ...
  <!--  <div class="container">
      <div class="row">
        <div class="col-log-9 col-md-9">
          <div class="panel panel-primary">
            <div class="panel-heading">Enrolment Site Data</div>
              <div class="panel-body">
                <img src="assets/img/patient_data.png">
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-log-9 col-md-9">
          <div class="panel panel-primary">
            <div class="panel-heading">Enrolment Site Overview</div>
            <div class="panel-body">
              <div class="form-group row">
                <label class="col-sm-2 control-label">Total Trials</label>
                <div class="col-sm-10">

                  <?php echo $this->db->count_all_results('trial_details');  ?>
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-2 control-label">Total Patients</label>
                <div class="col-sm-10">
